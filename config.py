...
def make_config():
  ...
  self_play.add_argument('--num_simulations', nargs='+', type=int, default=[18])
  self_play.add_argument('--max_history_length', type=int, default=1000)
  ...
  per.add_argument('--window_size', nargs='+', type=int, default=[1000000])
  ...
  ### Sampled Muzero
  training.add_argument('--num_sample_action', type=int, default=6)

  # PTSA
  training.add_argument('--abstract_alpha', type=float, default=0.5)
  ...
  load_and_save.add_argument('--save_state_frequency', type=int, default=1000000)
